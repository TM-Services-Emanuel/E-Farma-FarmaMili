...
public class Tickets {
    ...
    /**
     * @param aPuntoExpedicion the PuntoExpedicion to set
     */
     ...
     * @return the tickefin
     */
    public static int getTicketFin() {
        return TicketFin;
    }

    /**
     * @param aTicketFin the TicketFin to set
     */
    public static void setTicketFin(int aTicketFin) {
        TicketFin = aTicketFin;
    }
    private static int TicketFin;

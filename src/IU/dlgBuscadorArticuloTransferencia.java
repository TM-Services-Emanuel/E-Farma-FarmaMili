...
public class dlgBuscadorArticuloTransferencia extends javax.swing.JDialog {
    ...
    public static void Renders() {
        dlgBuscadorArticuloTransferencia.tbDetalle.getColumnModel().getColumn(10).setCellRenderer(new RenderDecimalPublico());
        dlgBuscadorArticuloTransferencia.tbDetalle.getColumnModel().getColumn(12).setCellRenderer(new RenderDecimalCosto());
        dlgBuscadorArticuloTransferencia.tbDetalle.getColumnModel().getColumn(15).setCellRenderer(new RenderDecimalVenta());
    ...
    private void tbDetalleMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbDetalleMouseClicked
        ...
        {
            controlFactura.selecArticulo_para_Transferir();
            dlgTransferencia.habilitarCANTCOSTO();
            dlgTransferencia.txtCant.requestFocus();
            dlgTransferencia.txtCant.selectAll();
            this.dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dlgBuscadorArticuloTransferencia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dlgBuscadorArticuloTransferencia dialog = new dlgBuscadorArticuloTransferencia(new javax.swing.JFrame(), true);

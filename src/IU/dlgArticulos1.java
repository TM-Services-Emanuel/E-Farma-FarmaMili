...
public class dlgArticulos1 extends javax.swing.JDialog {
    ...
    public static void Renders() {
        dlgArticulos1.tbProductos.getColumnModel().getColumn(12).setCellRenderer(new RenderDecimalCosto());
        dlgArticulos1.tbProductos.getColumnModel().getColumn(10).setCellRenderer(new RenderDecimalPublico());
        dlgArticulos1.tbProductos.getColumnModel().getColumn(15).setCellRenderer(new RenderDecimalVenta());
        dlgArticulos1.tbProductos.getColumnModel().getColumn(14).setCellRenderer(new RenderDecimal1conPuntos());
        dlgArticulos1.tbProductos.getColumnModel().getColumn(17).setCellRenderer(new RenderDecimal1conPuntos());
    }

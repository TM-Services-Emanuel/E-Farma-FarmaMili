...
public class dlgConsultarCreditosFacturas extends javax.swing.JDialog {
    public ReporteF jasper;
    private static String ImpresoraPred;
    static DataSourceService dss = new DataSourceService();

    public dlgConsultarCreditosFacturas(java.awt.Frame parent, boolean modal) throws SQLException {
        super(parent, modal);
        initComponents();
        titulo();
        jasper = new ReporteF();
        CabecerasTablas.consFacturasCreditos(tblFactura);
        controlFactura.listFacturasCreditoPendienteGeneral(tblFactura);
        txtLimiteCredito.setText("0");
        DecimalFormat df = new DecimalFormat("#,###");
        txtDeudaTotal.setText(df.format(controlFactura.getTotalFactCreditos()));
    ...
    final void titulo() {
        if (Software.getSoftware().equals("null")) {
            this.setTitle("GESTIONAR CUENTAS PENDIENTES - FACTURAS LEGALES CRÉDITO");
        } else {
            this.setTitle(Software.getSoftware() + " - GESTIONAR CUENTAS PENDIENTES - FACTURAS LEGALES CRÉDITO");
        }
    }

    public static void Renders() {
        dlgConsultarCreditosFacturas.tblFactura.getColumnModel().getColumn(9).setCellRenderer(new RenderDecimal());
    }
    ...
    public static void sumarCuentas(String cod) {
        String sql = "SELECT SUM(fac_totalfinal) FROM factura_l WHERE clientes_cli_codigo=" + cod + " AND estado='PENDIENTE' AND fac_indicador='S'";
        try (Connection cn = dss.getDataSource().getConnection(); Statement st = cn.createStatement(); ResultSet rss = st.executeQuery(sql)) {
            rss.first();
    ...
    public static void Cant() {
        int Cantidad = dlgConsultarCreditosFacturas.tblFactura.getRowCount();
    ...
    public static void imprimirTicket_Pago() {
        ...
        try {
            String sqlIP = "SELECT * FROM v_puntoemision3 WHERE tipo='T' AND estado='Activo' AND ip='" + traerIP.getIP() + "'";
            try (Connection cn = dss.getDataSource().getConnection(); Statement st = cn.createStatement(); ResultSet rss = st.executeQuery(sqlIP)) {
                rss.last();
                do {
            ...
            printer.toFile("FACTURA_PAGO.txt");
            FileInputStream inputStream = null;

            try {
                inputStream = new FileInputStream("FACTURA_PAGO.txt");
                ...
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel6Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel6Layout.createSequentialGroup()
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(txtCaja, javax.swing.GroupLayout.PREFERRED_SIZE, 76, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(txtCodIngreso, javax.swing.GroupLayout.PREFERRED_SIZE, 78, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void btnImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImprimirActionPerformed
        ...
        if (dlgConsultarCreditosFacturas.tblFactura.getSelectedRow() < 0) {
            Mensajes.error("Seleccione una fila de la tabla");
        } else {
            int x = dlgConsultarCreditosFacturas.tblFactura.getSelectedRow();
            String estado = dlgConsultarCreditosFacturas.tblFactura.getValueAt(x, 11).toString();
            if (estado.equals("ANULADO")) {
                ...
                if (rpta == 0) {
                    try {
                        String cod = dlgConsultarCreditosFacturas.tblFactura.getValueAt(x, 0).toString();
                        String fecha = dlgConsultarCreditosFacturas.tblFactura.getValueAt(x, 2).toString();
                        String hora = dlgConsultarCreditosFacturas.tblFactura.getValueAt(x, 3).toString();
                        String fact = dlgConsultarCreditosFacturas.tblFactura.getValueAt(x, 6).toString();
                        String caja = dlgConsultarCreditosFacturas.tblFactura.getValueAt(x, 5).toString();
                        String condicion = dlgConsultarCreditosFacturas.tblFactura.getValueAt(x, 7).toString();
                        String total = dlgConsultarCreditosFacturas.tblFactura.getValueAt(x, 9).toString();
    ...
    private void btnGenerarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGenerarActionPerformed
        ...
        if (lblCodDetalle.getText().isEmpty()) {
            ...
            controlFactura.listFacturasCreditoPendienteActivo2(tblFactura, lblCodDetalle.getText());
            Renders();
    ...
    private void btnRegitrarPagoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegitrarPagoActionPerformed
        ...
        if (dlgConsultarCreditosFacturas.tblFactura.getSelectedRow() < 0) {
            ...
            if (!fe.equals(Fecha.fechaCorrecta())) {
                ...
                int x = dlgConsultarCreditosFacturas.tblFactura.getSelectedRow();
                String estado = dlgConsultarCreditosFacturas.tblFactura.getValueAt(x, 11).toString();
                String pago = dlgConsultarCreditosFacturas.tblFactura.getValueAt(x, 8).toString();
                if (estado.equals("ANULADO")) {
                    ...
                    int rpta = Mensajes.confirmar("¿Seguro que desea Registrar el pago de esta Factura Legal?");
                    if (rpta == 0) {
                        try {
                            try {
                            ...
                            lbCodVenta.setText(dlgConsultarCreditosFacturas.tblFactura.getValueAt(x, 0).toString());
                            lblCodCliente.setText(dlgConsultarCreditosFacturas.tblFactura.getValueAt(x, 4).toString());
                            txtCliente.setText(dlgConsultarCreditosFacturas.tblFactura.getValueAt(x, 1).toString());
                            String fact = dlgConsultarCreditosFacturas.tblFactura.getValueAt(x, 6).toString();
                            String caja = dlgConsultarCreditosFacturas.tblFactura.getValueAt(x, 5).toString();
                            String fecha = dlgConsultarCreditosFacturas.tblFactura.getValueAt(x, 2).toString();
                            ...
                            txtObservacion.setText("PAGO DE FACTURA CREDITO N°:" + fact + " DE LA FECHA:" + Fecha.formatoFechaMuestra(fecha));
                            DecimalFormat df = new DecimalFormat("#,###");
                            txtImporte.setText(df.format(Integer.valueOf(dlgConsultarCreditosFacturas.tblFactura.getValueAt(x, 9).toString().trim().replace(".", "").replace(",", ""))));
                            txtImporteL.setText(dlgConsultarCreditosFacturas.tblFactura.getValueAt(x, 9).toString());
    ...
    private void btnBuscarClienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarClienteActionPerformed
        // TODO add your handling code here:
        try {
            dlgBuscarCliente2 bcliente = new dlgBuscarCliente2(null, true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dlgConsultarCreditosFacturas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            try {
                dlgConsultarCreditosFacturas dialog = new dlgConsultarCreditosFacturas(new javax.swing.JFrame(), true);
                ...
                Logger.getLogger(dlgConsultarCreditosFacturas.class.getName()).log(Level.SEVERE, null, ex);
            }
        });
    }
